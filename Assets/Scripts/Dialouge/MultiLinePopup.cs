...
public class MultiLinePopup : ChatHelper
{
    ...
    void OnValidate()
    {
        ...
        Debug.Log("Performed update to Multi-Line Popup Text");
    ...
    private void Awake()
    {
        ...
        // Move Camera
        cameraController.startConversation(player.gameObject.transform, player.gameObject.transform);
...
#if UNITY_EDITOR
[CustomEditor(typeof(MultiLinePopup))]
public class MultiLinePopupEditor : Editor
{
    public override void OnInspectorGUI()
    {
        ...
        {
            MultiLinePopup temp = (MultiLinePopup)target;
            temp.CreatePopups();
        }
    }
}
